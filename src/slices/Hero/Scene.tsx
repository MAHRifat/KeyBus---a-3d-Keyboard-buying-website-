...
export const Scene = () => {
  const { positionX, positionY, positionZ, rotationX, rotationY, rotationZ } =
    ...
    const scalingFactor = window.innerWidth <= 853 ? .5 : .8;
      ...
      <group scale={scalingFactor}>
        ...
        <group>
          <Keycap
            position={[0, -0.4, 2.6]}
            texture={0}
            rotation={[1.6, 0.5, 0.2]}
          />
          <Keycap
            position={[-1.4, 0, 2.3]}
            texture={1}
            rotation={[2.4, 0.5, -1.2]}
          />
          <Keycap
            position={[-1.8, 1, 1.5]}
            texture={2}
            rotation={[0.9, 2.9, 0.1]}
          />
          <Keycap position={[0, 1, 1]} texture={3} rotation={[1.3, -3.1, 0]} />
          <Keycap
          ...
          <Keycap
            ...
            texture={5}
            rotation={[1.3, 3.1, -0.4]}
          />
          <Keycap position={[0, 1, 2]} texture={6} rotation={[2.3, 3, -0.4]} />
          <Keycap
          ...
          <Keycap
            ...
            rotation={[1.5, 2.5, 0]}
          />
          <Keycap position={[2, 0, 1]} texture={4} rotation={[1.5, 2.5, 0]} />
        </group>
      </group>
